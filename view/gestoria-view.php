    ...
    <section class="main-content-wrapper">
        <section id="main-content">
            <div class="row">
                <div class="col-md-12">
                        ...
                        <ul class="breadcrumb  pull-right">
                            ...
                            <li class="active">Gestoria</li>
                        </ul>
                        <!--breadcrumbs end -->
                        <br>
                    <h1 class="h1">Gestoria</h1>
                </div>
            </div>
            ...
            <div class="row">
               ...
               <div class="col-md-6">
                    <div class="btn-group ">
                        <a type="button" href="./?view=gesser" class="btn btn-success" style="color: #fff">
                ...
                <div class="col-md-offset-10">
                    <!-- modals -->
                        <?php
                            include "modals/agregar/agregar_gestoria.php";
                            include "modals/editar/editar_gestoria.php";
                            include "modals/mostrar/mostrar_gestoria.php";
                        ?>
                    <!-- /end modals -->
...
<script>
    ...
    function load(page){
        ...
        $("#loader").fadeIn('slow');
        $.ajax({
            url:'view/ajax/gestoria_ajax.php',
            data: parametros,
...
<script>
    $( "#update_register" ).submit(function( event ) {
     ...
     var parametros = $(this).serialize();
         $.ajax({
                type: "POST",
                url: "view/ajax/editar/editar_gestoria.php",
                data: parametros,
                 beforeSend: function(objeto){
                    $("#resultados_ajax").html("Enviando...");
                  },
...
<script>
    function editar(id){
        ...
        $.ajax({
                url:'view/modals/editar/gestoria.php',
                data: parametros,
                 beforeSend: function(objeto){
    ...
    function mostrar(id){
        var parametros = {"action":"ajax","id":id};
        $.ajax({
                url:'view/modals/mostrar/gestoria.php',
                data: parametros,
                 beforeSend: function(objeto){
    ...
    function enviar(id){
        ...
        var parametros = {"action":"ajax","id":id};
        $.ajax({
                url:'view/modals/mostrar/correo-gestoria.php',
                data: parametros,
                 beforeSend: function(objeto){
