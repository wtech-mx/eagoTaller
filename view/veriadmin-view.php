        ...
        <section id="main-content">
            <div class="row">
                <div class="col-md-12">
                        ...
                        <ul class="breadcrumb  pull-right">
                            ...
                            <li class="active">Administración de Verificación</li>
                        </ul>
                        <!--breadcrumbs end -->
                        <br>
                    <h1 class="h1">Administración de Verificación</h1>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-offset-10">
                    <!-- modals -->
                        <?php 
                            include "modals/editar/editar_veriadmin.php";
                            include "modals/mostrar/mostrar_veriadmin.php";
                        ?>
                    <!-- /end modals -->
...
<script>
    ...
    function load(page){
        ...
        $("#loader").fadeIn('slow');
        $.ajax({
            url:'view/ajax/veriadmin_ajax.php',
            data: parametros,
...
<script>
    $( "#update_register" ).submit(function( event ) {
     ...
     var parametros = $(this).serialize();
         $.ajax({
                type: "POST",
                url: "view/ajax/editar/editar_veriadmin.php",
                data: parametros,
                 beforeSend: function(objeto){
                    $("#resultados_ajax").html("Enviando...");
                  },
...
<script>
    function editar(id){
        ...
        $.ajax({
                url:'view/modals/editar/veriadmin.php',
                data: parametros,
                 beforeSend: function(objeto){
    ...
    function mostrar(id){
        var parametros = {"action":"ajax","id":id};
        $.ajax({
                url:'view/modals/mostrar/veriadmin.php',
                data: parametros,
                 beforeSend: function(objeto){
