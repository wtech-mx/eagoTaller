<?php
    ...
    $sql = "UPDATE estetica SET fecha_rep='".$fecha_rep."', id_cliente='".$cliente."', idvehiculo='".$vehiculo."' datos='".$datos."', idtrasladista='".$trasladista."', idtaller='".$taller."', otros='".$otros."', vendedor='".$vendedor."', origen='".$origen."' WHERE id='".$id."' ";
