<?php
    ...
    $sql = "UPDATE mantenimiento SET fecha_man='".$fecha_man."', idcliente='".$cliente."', idvehiculo='".$vehiculo."', datos='".$datos."', trasladistas='".$trasladistas."', gasolina='".$gasolina."', otros='".$otros."', vendedor='".$vendedor."' WHERE id='".$id."' ";
