<?php
	...
	if (empty($_POST['autobus'])){
       ...
       // escaping, additionally removing everything that could be (html/javascript-) code
        $autobus = mysqli_real_escape_string($con,(strip_tags($_POST["autobus"],ENT_QUOTES)));
        $gasolina_admin = mysqli_real_escape_string($con,(strip_tags($_POST["gasolina_admin"],ENT_QUOTES)));
        $casetas_admin = mysqli_real_escape_string($con,(strip_tags($_POST["casetas_admin"],ENT_QUOTES)));
