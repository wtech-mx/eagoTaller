<?php
    ...
    $datos = mysqli_real_escape_string($con,(strip_tags($_POST["documento"],ENT_QUOTES)));
	$id=intval($_POST['id']);
    


	// UPDATE data into database
    $sql = "UPDATE documentacion SET nombre='".$nombre."', apellido='".$apellido."', vehiculo='".$vehiculo."', documento='".$documento."' WHERE id='".$id."' ";
