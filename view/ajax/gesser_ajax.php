<?php
	...
	$id=$_REQUEST["id"];
	$id=intval($id);
	if($delete=mysqli_query($con, "DELETE FROM gestoria WHERE id='$id'")){
		$aviso="Bien hecho!";
        ...
        <tbody>
            <tr>
                ...
                <td class="text-right">
                    ...
                    <a style="color: white;" class="btn btn-warning btn-square btn-xs" href="./?view=editar_gesser&id=<?php echo $id;?>"><i class='fa fa-edit'></i></a>
