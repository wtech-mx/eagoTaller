<?php
    ...
    if ($query_new_insert) {
?>
		<img class="img-responsive" src="view/resources/images/<?php echo $image_name;?>" alt="Imagen del factura 2" data-toggle="modal" data-target="#myModal" style='cursor:pointer'>
