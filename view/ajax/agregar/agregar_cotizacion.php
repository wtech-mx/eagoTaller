<?php
	...
	if (empty($_POST['nombre'])) {
            ...
            $errors[] = "Mensaje está vacío.";
        }  elseif (empty($_POST['correo'])) {
            $errors[] = "Correo está vacío.";
        }  elseif (
        	!empty($_POST['nombre'])
            && !empty($_POST['correo'])
            && !empty($_POST['mensaje'])        
