<?php
	...
	if (empty($_POST['fecha_repa'])){
		...
		require_once ("../../../config/config.php");//Contiene las variables de configuracion para conectar a la base de datos
			...
			$sql = "INSERT INTO reparaciones (fecha_repa, idcliente, descripcion, idvehiculo, idtaller, fecha_carga) VALUES('".$fecha_repa."','".$cliente."','".$descripcion."','".$vehiculo."','".$taller."','".$fecha_carga."');";
