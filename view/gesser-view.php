        ...
        <section id="main-content">
            <div class="row">
                <div class="col-md-12">
                        ...
                        <ul class="breadcrumb  pull-right">
                            ...
                            <li class="active">Servicios de Gestoría</li>
                        </ul>
                        <!--breadcrumbs end -->
                        <br>
                    <h1 class="h1">Servicios de Gestoría</h1>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-offset-10">
                    <!-- modals -->
                        <?php 
                            include "modals/editar/editar_gesser.php";
                            include "modals/mostrar/mostrar_gesser.php";
                        ?>
                    <!-- /end modals -->
...
<script>
    $( "#update_register" ).submit(function( event ) {
     ...
     var parametros = $(this).serialize();
         $.ajax({
                type: "POST",
                url: "view/ajax/editar/editar_gesser.php",
                data: parametros,
                 beforeSend: function(objeto){
                    $("#resultados_ajax").html("Enviando...");
                  },
...
<script>
    function editar(id){
        ...
        $.ajax({
                url:'view/modals/editar/gesser.php',
                data: parametros,
                 beforeSend: function(objeto){
    ...
    function mostrar(id){
        var parametros = {"action":"ajax","id":id};
        $.ajax({
                url:'view/modals/mostrar/gesser.php',
                data: parametros,
                 beforeSend: function(objeto){
