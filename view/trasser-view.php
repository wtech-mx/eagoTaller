        ...
        <section id="main-content">
            <div class="row">
                <div class="col-md-12">
                        ...
                        <ul class="breadcrumb  pull-right">
                            ...
                            <li class="active">Servicios de Traslados</li>
                        </ul>
                        <!--breadcrumbs end -->
                        <br>
                    <h1 class="h1">Servicios de Traslados</h1>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-offset-10">
                    <!-- modals -->
                        <?php 
                            include "modals/editar/editar_trasser.php";
...
<script>
    ...
    function load(page){
        ...
        $("#loader").fadeIn('slow');
        $.ajax({
            url:'view/ajax/trasser_ajax.php',
            data: parametros,
...
<script>
    $( "#update_register" ).submit(function( event ) {
     ...
     var parametros = $(this).serialize();
         $.ajax({
                type: "POST",
                url: "view/ajax/editar/editar_trasser.php",
                data: parametros,
                 beforeSend: function(objeto){
                    $("#resultados_ajax").html("Enviando...");
                  },
...
<script>
    function editar(id){
        ...
        $.ajax({
                url:'view/modals/editar/trasser.php',
                data: parametros,
                 beforeSend: function(objeto){
    ...
    function mostrar(id){
        var parametros = {"action":"ajax","id":id};
        $.ajax({
                url:'view/modals/mostrar/trasser.php',
                data: parametros,
                 beforeSend: function(objeto){
