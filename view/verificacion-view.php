            ...
            <div class="row">
                <div class="col-xs-3">
                    <div class="input-group">
                        <input type="text" class="form-control" placeholder="fecha de verificación" id='q' onkeyup="load(1);">
               ...
               <div class="col-md-6">
                    <div class="btn-group ">
                        <a type="button" href="./?view=veriser" class="btn btn-success" style="color: #fff">
                ...
                <div class="col-md-offset-10">
                    <!-- modals -->
                        <?php
                            include "modals/agregar/agregar_verificacion.php";
                            include "modals/editar/editar_verificacion.php";
                            include "modals/mostrar/mostrar_verificacion.php";
                        ?>
                    <!-- /end modals -->
...
<script>
    ...
    function load(page){
        ...
        $("#loader").fadeIn('slow');
        $.ajax({
            url:'view/ajax/verificacion_ajax.php',
            data: parametros,
...
<script>
    $( "#new_register" ).submit(function( event ) {
     ...
     var parametros = $(this).serialize();
         $.ajax({
                type: "POST",
                url: "view/ajax/agregar/agregar_verificacion.php",
                data: parametros,
                 beforeSend: function(objeto){
...
<script>
    $( "#update_register" ).submit(function( event ) {
     ...
     var parametros = $(this).serialize();
         $.ajax({
                type: "POST",
                url: "view/ajax/editar/editar_verificacion.php",
                data: parametros,
                 beforeSend: function(objeto){
                    $("#resultados_ajax").html("Enviando...");
                  },
...
<script>
    function editar(id){
        ...
        $.ajax({
                url:'view/modals/editar/verificacion.php',
                data: parametros,
                 beforeSend: function(objeto){
...
function mostrar(id){
     ...
     function enviar(id){
        swal({
          title: "¿Deseas enviar el servicio?",
        ...
        var parametros = {"action":"ajax","id":id};
        $.ajax({
                url:'view/modals/mostrar/correo-verificacion.php',
                data: parametros,
                 beforeSend: function(objeto){
            ...
            swal("Se ha cancelado el envio del servicio");
          }
        });
    }
</script>
