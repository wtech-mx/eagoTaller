...
<script>
    $( "#new_register" ).submit(function( event ) {
     ...
     var parametros = $(this).serialize();
         $.ajax({
                type: "POST",
                url: "view/ajax/agregar/agregar_mantenimiento.php",
                data: parametros,
                 beforeSend: function(objeto){
...
<script>
    $( "#update_register" ).submit(function( event ) {
     ...
     var parametros = $(this).serialize();
         $.ajax({
                type: "POST",
                url: "view/ajax/editar/editar_mantenimiento.php",
                data: parametros,
                 beforeSend: function(objeto){
                    $("#resultados_ajax").html("Enviando...");
                  },
...
<script>
    function editar(id){
        ...
        $.ajax({
                url:'view/modals/editar/mantenimiento.php',
                data: parametros,
                 beforeSend: function(objeto){
    ...
    function mostrar(id){
        var parametros = {"action":"ajax","id":id};
        $.ajax({
                url:'view/modals/mostrar/mantenimiento.php',
                data: parametros,
                 beforeSend: function(objeto){
     ...
     function enviar(id){
        ...
        var parametros = {"action":"ajax","id":id};
        $.ajax({
                url:'view/modals/mostrar/correo-mantenimiento.php',
                data: parametros,
                 beforeSend: function(objeto){
