        ...
        <section id="main-content">
            <div class="row">
                <div class="col-md-12">
                        ...
                        <!--breadcrumbs end -->
                        <br>
                    <h1 class="h1">Comprobacion de servicio Mantenimiento</h1>
                </div>
            </div>
...
<script>
    $( "#update_register" ).submit(function( event ) {
     ...
     var parametros = $(this).serialize();
         $.ajax({
                type: "POST",
                url: "view/ajax/editar/editar_manser.php",
                data: parametros,
                 beforeSend: function(objeto){
...
<script type="text/javascript">
    function enviar(id){
        ...
        $.ajax({
                url:'view/modals/mostrar/correo-manadmin.php',
                data: parametros,
                 beforeSend: function(objeto){
...
<script>
    function editar(id){
        var parametros = {"action":"ajax","id":id};
        $.ajax({
                url:'view/modals/editar/manser.php',
                data: parametros,
                 beforeSend: function(objeto){
    ...
    function mostrar(id){
        var parametros = {"action":"ajax","id":id};
        $.ajax({
                url:'view/modals/mostrar/manser.php',
                data: parametros,
                 beforeSend: function(objeto){
