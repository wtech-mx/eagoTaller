    ...
    <section class="main-content-wrapper">
        <section id="main-content">
            ...
            <div class="row">
               ...
               <div class="col-md-6">
                    <div class="btn-group ">
                        <a type="button" href="./?view=trasser" class="btn btn-success" style="color: #fff">
                ...
                <div class="col-md-offset-10">
                    <!-- modals -->
                        <?php
                            include "modals/agregar/agregar_traslados.php";
                            include "modals/editar/editar_traslados.php";
                            include "modals/mostrar/mostrar_traslados.php";
                        ?>
                    <!-- /end modals -->
...
<script>
    ...
    function load(page){
        ...
        $("#loader").fadeIn('slow');
        $.ajax({
            url:'view/ajax/traslados_ajax.php',
            data: parametros,
...
<script>
    $( "#new_register" ).submit(function( event ) {
     ...
     var parametros = $(this).serialize();
         $.ajax({
                type: "POST",
                url: "view/ajax/agregar/agregar_traslados.php",
                data: parametros,
                 beforeSend: function(objeto){
...
<script>
    $( "#update_register" ).submit(function( event ) {
     ...
     var parametros = $(this).serialize();
         $.ajax({
                type: "POST",
                url: "view/ajax/editar/editar_traslados.php",
                data: parametros,
                 beforeSend: function(objeto){
                    $("#resultados_ajax").html("Enviando...");
                  },
...
<script>
    function editar(id){
        ...
        $.ajax({
                url:'view/modals/editar/traslados.php',
                data: parametros,
                 beforeSend: function(objeto){
...
function mostrar(id){
        var parametros = {"action":"ajax","id":id};
        $.ajax({
                url:'view/modals/mostrar/traslados.php',
                data: parametros,
                 beforeSend: function(objeto){
     ...
     function enviar(id){
        ...
        var parametros = {"action":"ajax","id":id};
        $.ajax({
                url:'view/modals/mostrar/correo-traslados.php',
                data: parametros,
                 beforeSend: function(objeto){
