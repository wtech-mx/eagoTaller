        ...
        <section id="main-content">
            ...
            <div class="row">
                        ...
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal" role="form" name="update_register" id="update_register" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label for="idfecha_man" class="col-sm-2 control-label">Fecha Registro: </label>
                                    <div class="col-sm-4">
                                        <?php echo $fecha_man;?>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                    <input type="file" name="imagefile5" class="form-control" id="imagefile5" onchange="upload_foto5(<?php echo $manser_id; ?>);">
                                    </div>
                                    <label for="imagefile6" class="col-sm-2 control-label">Foto 6: </label>
                                    <div class="col-sm-4">
                                        <input type="file" name="imagefile6" class="form-control" id="imagefile6" onchange="upload_foto6(<?php echo $manser_id; ?>);">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                    <input type="file" name="imagefile7" class="form-control" id="imagefile7" onchange="upload_foto7(<?php echo $manser_id; ?>);">
                                    </div>
                                    <label for="imagefile8" class="col-sm-2 control-label">Foto 8: </label>
                                    <div class="col-sm-4">
                                        <input type="file" name="imagefile8" class="form-control" id="imagefile8" onchange="upload_foto8(<?php echo $manser_id; ?>);">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                    <input type="file" name="imagefile9" class="form-control" id="imagefile9" onchange="upload_foto9(<?php echo $manser_id; ?>);">
                                    </div>
                                    <label for="imagefile10" class="col-sm-2 control-label">Foto 10: </label>
                                    <div class="col-sm-4">
                                        <input type="file" name="imagefile10" class="form-control" id="imagefile10" onchange="upload_foto10(<?php echo $manser_id; ?>);">
                                    </div>
                                </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title">Fotos de comprobacion de Servicio</h3>
                            <div class="actions pull-right">
                                <i class="fa fa-chevron-down"></i>
                                <i class="fa fa-times"></i>
                            </div>
...
<script>
    ...
    function upload_foto5(manser_id){
        ...
        $.ajax({
            url: "view/ajax/images/foto5_manser_ajax.php",        // Url to which the request is send
            type: "POST",             // Type of request to be send, called as method
            data: data,               // Data sent to server, a set of key/value pairs (i.e. form fields and values)
            contentType: false,       // The content type used when sending data to the server.
            cache: false,             // To unable request pages to be cached
    ...
    function upload_foto6(manser_id){
        ...
        $.ajax({
            url: "view/ajax/images/foto6_manser_ajax.php",        // Url to which the request is send
            type: "POST",             // Type of request to be send, called as method
            data: data,               // Data sent to server, a set of key/value pairs (i.e. form fields and values)
            contentType: false,       // The content type used when sending data to the server.
            cache: false,             // To unable request pages to be cached
    ...
    function upload_foto7(manser_id){
        ...
        $.ajax({
            url: "view/ajax/images/foto7_manser_ajax.php",        // Url to which the request is send
            type: "POST",             // Type of request to be send, called as method
            data: data,               // Data sent to server, a set of key/value pairs (i.e. form fields and values)
            contentType: false,       // The content type used when sending data to the server.
            cache: false,             // To unable request pages to be cached
    ...
    function upload_foto8(manser_id){
        ...
        $.ajax({
            url: "view/ajax/images/foto8_manser_ajax.php",        // Url to which the request is send
            type: "POST",             // Type of request to be send, called as method
            data: data,               // Data sent to server, a set of key/value pairs (i.e. form fields and values)
            contentType: false,       // The content type used when sending data to the server.
            cache: false,             // To unable request pages to be cached
    ...
    function upload_foto9(manser_id){
        ...
        $.ajax({
            url: "view/ajax/images/foto9_manser_ajax.php",        // Url to which the request is send
            type: "POST",             // Type of request to be send, called as method
            data: data,               // Data sent to server, a set of key/value pairs (i.e. form fields and values)
            contentType: false,       // The content type used when sending data to the server.
            cache: false,             // To unable request pages to be cached
    ...
    function upload_foto10(manser_id){
        ...
        $.ajax({
            url: "view/ajax/images/foto10_manser_ajax.php",        // Url to which the request is send
            type: "POST",             // Type of request to be send, called as method
            data: data,               // Data sent to server, a set of key/value pairs (i.e. form fields and values)
            contentType: false,       // The content type used when sending data to the server.
            cache: false,             // To unable request pages to be cached
